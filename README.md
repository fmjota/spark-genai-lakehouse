...
Spark optimizadas** —sin cuellos de botella—, y lo persiste en un **lakehouse Delta Lake**.
...
lleva **confianza**, la calibración se trata con honestidad y se monitorea el **drift** de
la distribución del texto.

> **Demuestra:** aplicar IA de vanguardia sobre Big Data sin reventar el rendimiento.
...
- **[`docs/spark-genai-udf.md`](docs/spark-genai-udf.md)** — el patrón HF-en-Spark sin cuellos de botella (el corazón).
...
- **`CLAUDE.md`** — memoria de trabajo y bitácora de decisiones.
